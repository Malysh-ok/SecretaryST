...
public static class RepositoryPlaceholder
{
    ...
    public static async Task<Result<List<RefereeJobTitle>>> FillRefereeJobTitles(IRepository repository)
    {
        ...
        {
            new(JobTitleEnm.ChiefReferee, "Главный судья"),
            new(JobTitleEnm.ChiefSecretary, "Главный секретарь"),
            new(JobTitleEnm.DeputyForRefereeing, "Зам. гл. судьи по судейству"),
            new(JobTitleEnm.DeputyForSecurity, "Зам. гл. судьи по безопасности"),
            new(JobTitleEnm.HeadOfDistance, "Начальник дистанции"),
            new(JobTitleEnm.MandateChairman, "Председатель комиссии по допуску"),
            new(JobTitleEnm.Inspector, "Судья-инспектор"),
            new(JobTitleEnm.Secretary1, "Секретарь - 1"),
            new(JobTitleEnm.Secretary2, "Секретарь - 2"),
            new(JobTitleEnm.Secretary3, "Секретарь - 3"),
            new(JobTitleEnm.Secretary4, "Секретарь - 4"),
            new(JobTitleEnm.Secretary5, "Секретарь - 5"),
            new(JobTitleEnm.Secretary6, "Секретарь - 6"),
            new(JobTitleEnm.Secretary7, "Секретарь - 7"),
            new(JobTitleEnm.Secretary8, "Секретарь - 8"),
            new(JobTitleEnm.Secretary9, "Секретарь - 9"),
            new(JobTitleEnm.Secretary10, "Секретарь - 10"),
        };
