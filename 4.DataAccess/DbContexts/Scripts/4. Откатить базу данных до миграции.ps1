Write-Host "Откатываем базу данных до миграции" -ForegroundColor Green
                Write-Host ""
                ...
                dotnet ef database update $MigrationName -s "D:\Документы\_ПРОЕКТЫ\_Программирование\C#\SecretaryST\1.Presentation\Shell\Shell.csproj" -p $dbContextProjPath -v
                pause
