...
public class ProblemException : BaseException
{
    ...
    /// </summary>
    /// <inheritdoc cref="ProblemException(string, Exception, string, ExcptnTypeEnm)"/>
    public static ProblemException CreateFromErrorCode(string errCode, Exception? innerException = null, 
        string? message = null, ExcptnTypeEnm excptnType = ExcptnTypeEnm.Error)
