...
public class SportEventService(IRepository repository)
{
    ...
    public async Task<Result<IList<SportEvent>>> GetSportEventsAsync(CompetitionData competition)
    {
        ...
        if (competition == null!)
        {
            return Result<IList<SportEvent>>.Fail(
                new AppException(AppPhrases.SportEventsLoadError, new AppException(AppPhrases.CompetitionDataIsNull))
            );
        }
        ...
        if (! result)
            return Result<IList<SportEvent>>.Fail(new AppException(AppPhrases.SportEventsLoadError, result.Excptn));
        ...
        if (! sportEventsResult)
            return Result<IList<SportEvent>>.Fail(new AppException(AppPhrases.SportEventsLoadError, sportEventsResult.Excptn));
    ...
    public async Task<Result<SportEvent>> CreateSportEventAsync(CompetitionData? competition)
    {
        ...
        if (competition == null!)
        {
            return Result<SportEvent>.Fail(
                new AppException(AppPhrases.SportEventCreateError, new AppException(AppPhrases.CompetitionDataIsNull))
            );
        }
        ...
        if (! disciplineResult)
        {
            var innerException = new AppException(AppPhrases.DisciplineLoadError, disciplineResult.Excptn);
            return Result<SportEvent>.Fail(
                new AppException(AppPhrases.SportEventCreateError, innerException)
            );
        }
        ...
        {
            return Result<SportEvent>.Fail(
                new AppException(AppPhrases.SportEventCreateError, intResult.Excptn)
            );
        }
    ...
    public Result<int> RemoveSportEvent(SportEvent sportEventToRemove)
    {
        ...
        if (! intResult)
        {
            return Result<int>.Fail(
                new AppException(AppPhrases.SportEventRemoveError, intResult.Excptn)
            );
        }
    ...
    public async Task<Result<IList<DisciplineGroup>>> GetDisciplineGroupsAsync()
    {
        ...
        return disciplineGroupsResult
            ...
            : Result<IList<DisciplineGroup>>.Fail(new AppException(AppPhrases.DisciplineGroupsLoadError, 
                disciplineGroupsResult.Excptn));
    }
    ...
    public async Task<Result<IList<DisciplineSubGroup>>> GetDisciplineSubGroupsAsync()
    {
        ...
        return disciplineSubGroupsResult
            ...
            : Result<IList<DisciplineSubGroup>>.Fail(new AppException(AppPhrases.DisciplineSubGroupsLoadError, 
                disciplineSubGroupsResult.Excptn));
    }
    ...
    public async Task<Result<IList<Discipline>>> GetDisciplinesAsync()
    {
        ...
        return disciplinesResult
            ...
            : Result<IList<Discipline>>.Fail(new AppException(AppPhrases.DisciplinesLoadError, 
                disciplinesResult.Excptn));
    }
